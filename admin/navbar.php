...
<div class="n">
	...
	<ul class="nav">
		...
		<li  class="test">
			...
			<ul>
				<li>
					<a href="show.php?id=1">Jewelry</a>
				</li>
				<li>
					<a href="show.php?id=2">Medals</a>
				</li>
			</ul>
		</li>
		<!--=============================================================================================================-->
		...
		<li>
			...
			<ul>
				<li>
					<a href="show.php?id=3">Clothes</a>
				</li>
				<li>
					<a href="show.php?id=4">Toys</a>
				</li>
				     <li>
					<a href="show.php?id=5">Bags</a>
				</li>
			</ul>
		</li>
		<!--=============================================================================================================-->
		...
		<li>
			<a href="#">Art work</a>
			<ul>
				<li><a href="show.php?id=6">Paintings</a></li>
				<li><a href="show.php?id=7">Paper art</a></li>
				<li><a href="show.php?id=8">Portrait</a></li>
        ...
        <li class="loginclick" style="float: right; padding-left: 50px" >
			...
			<li>
			<a href="users.php?type='.$_SESSION['type'].'">Profile</a>
			</li>
			<li>
			<a href="SpecialOrder/Order.php?type='.$_SESSION['type'].'">Spitial Order</a>
			</li>
			<li>
