...
if (session_status() == PHP_SESSION_NONE) {
	...
	<ul class="nav">
		...
		<li >
			...
			<a href="../index.php"><img src="../images/logo.png" style="height: auto; width: 150px;  margin-left: 19px;padding-top: 20px; " alt=""  class="logoimg"/></a>
			</div>
		</li>
		<!--=================================
		============================================================================-->
		<!--SP Order-->
		<li  class="test">
			<a href="SpecialOrder/Order.php" style=""><i id="aassaass" class="fa fa-asterisk fa-3x" aria-hidden="true" style="color: #fff; padding: 
			10px 32px 0 240px; " ></i> </a>
		</li>
		<!--=============================================================================================================-->
		<!--Notification-->
		<li>
